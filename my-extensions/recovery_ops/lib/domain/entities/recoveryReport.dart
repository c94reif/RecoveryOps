...
class RecoveryReport {
  ...
  RecoveryReport copyWith({
    ...
    return RecoveryReport(
      ...
      navigatorLatitude: clearNavigatorLocation ? null : (navigatorLatitude ?? this.navigatorLatitude),
      navigatorLongitude: clearNavigatorLocation ? null : (navigatorLongitude ?? this.navigatorLongitude),
      routeGeometry: clearNavigatorLocation ? null : (routeGeometry ?? this.routeGeometry),
