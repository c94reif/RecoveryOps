...
class _ReportsPageState extends State<ReportsPage>
  ...
  Widget buildReportCard(RecoveryReport report) {
    ...
    final accentColor =
        isNavigating ? navBlue : (report.hasGeometry ? orange : masterChiefGreen);
  ...
  Widget buildExternalReportsList() {
    ...
    final nonEmptyBrackets = DistanceBracket.values
        .where((b) => grouped[b]!.isNotEmpty)
        .toList();
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  ...
                  buildReportList(
                      viewModel.yourReports, 'No reports sent yet'),
                ],
              ),
            ),
          ],
