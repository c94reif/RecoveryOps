...
import 'package:recovery_ops/presentation/profile/profilePage.dart';
...
void main() {
  ...
  testWidgets('ProfilePage renders all three fields', (WidgetTester tester) async {
  ...
  testWidgets('Save button is hidden when no edits are made', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();
  ...
  testWidgets('Save button appears when a field is edited', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();

    await tester.enterText(find.widgetWithText(CustomTextField, 'Name'), 'John Doe');
    await tester.pump();

    expect(find.widgetWithText(CustomButton, 'Save'), findsOneWidget);
  });

  testWidgets('Save button shows "Save" for a new profile', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();

    await tester.enterText(find.widgetWithText(CustomTextField, 'Name'), 'John');
    await tester.enterText(find.widgetWithText(CustomTextField, 'Unit'), 'Alpha');
    await tester.pump();

    expect(find.widgetWithText(CustomButton, 'Save'), findsOneWidget);
  });

  testWidgets('Saving a profile hides the save button', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();
  ...
  testWidgets('Saving persists data to the database', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();

    await tester.enterText(find.widgetWithText(CustomTextField, 'Name'), 'John Doe');
    await tester.enterText(find.widgetWithText(CustomTextField, 'Unit'), 'Alpha 1');
    await tester.pump();
  ...
  testWidgets('Shows validation snackbar when fields are empty', (WidgetTester tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();
  ...
  testWidgets('Save button shows "Save Edit" when editing existing profile', (WidgetTester tester) async {
    await dao.saveProfile(name: 'Jane', callSign: 'Wraith', unit: 'Bravo');

    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();

    await tester.enterText(find.widgetWithText(CustomTextField, 'Name'), 'Jane Updated');
    await tester.pump();

    expect(find.widgetWithText(CustomButton, 'Save Edit'), findsOneWidget);
  });

  testWidgets('Editing an existing profile saves the updated payload to the database', (WidgetTester tester) async {
    await dao.saveProfile(name: 'Jane', callSign: 'Wraith', unit: 'Bravo');
    ...
    await tester.enterText(find.widgetWithText(CustomTextField, 'Name'), 'Jane Updated');
    await tester.enterText(find.widgetWithText(CustomTextField, 'Unit'), 'Charlie 3');
    await tester.pump();
  ...
  testWidgets('Editing then reverting hides the save button', (WidgetTester tester) async {
    await dao.saveProfile(name: 'Jane', callSign: 'Wraith', unit: 'Bravo');

    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pumpAndSettle();

    await tester.enterText(find.widgetWithText(CustomTextField, 'Name'), 'Changed');
    await tester.pump();
    expect(find.byType(CustomButton), findsOneWidget);

    await tester.enterText(find.widgetWithText(CustomTextField, 'Name'), 'Jane');
    await tester.pump();
    expect(find.byType(CustomButton), findsNothing);
  });
}
