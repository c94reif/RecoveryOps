...
class FakeMapService implements sdk.MapService {
  @override
  Future<String> addMarker(sdk.LatLng location, {String? label, String? color, sdk.MarkerIcon? icon, sdk.MarkerDisposition? disposition}) async => 'marker-1';
  @override
  ...
  @override  Future<void> clearPolylines() async {}
  @override
  Future<sdk.ScreenPoint?> getPixelFromLocation(sdk.LatLng location) async => null;
  @override
...
void main() {
  ...
  testWidgets('Nav bar has Recovery, Reports, Nav, and Profile tabs', (WidgetTester tester) async {
