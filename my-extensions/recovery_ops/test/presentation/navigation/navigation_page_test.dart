...
void main() {
  ...
  group('bearing calculation', () {
    ...
    test('north is 0 degrees', () {
      final bearing = page.calculateBearing(
          const LatLng(33.0, -84.0), const LatLng(34.0, -84.0));
      expect(bearing, closeTo(0, 1));
    });

    test('east is 90 degrees', () {
      final bearing = page.calculateBearing(
          const LatLng(33.0, -85.0), const LatLng(33.0, -84.0));
      expect(bearing, closeTo(90, 1));
    });

    test('south is 180 degrees', () {
      final bearing = page.calculateBearing(
          const LatLng(34.0, -84.0), const LatLng(33.0, -84.0));
      expect(bearing, closeTo(180, 1));
    });

    test('west is 270 degrees', () {
      final bearing = page.calculateBearing(
          const LatLng(33.0, -84.0), const LatLng(33.0, -85.0));
