/// Standalone entry point for the LACE Report extension.
///
/// Dart mode (native):
...
///   `import 'package:lace_report/lace_report_plugin.dart';`
library;
...
import 'lace_report_plugin.dart';
...
void main() async {
  ...
  runApp(MaterialApp(
    ...
    home: Scaffold(
      appBar: AppBar(
        title: const Text('LACE Report — Preview'),
      ),
      body: LaceReportPlugin().build(context),
    ),
  ));
}
